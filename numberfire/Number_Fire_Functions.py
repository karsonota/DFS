...
directory = os.getcwd()
read_file = os.path.join(directory, '11122017\\DFS Big Board.xlsx')
dk_df = pd.read_excel(read_file, sheetname='DK Projections', names=col_head)
...
write_file = os.path.join(directory, '11122017\\DK_ALL_POS_PROJ_PROCESSED.xlsx')
writer = ExcelWriter(write_file)
